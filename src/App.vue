    ...
    <div class="container" ref="main">
      <div class="wrapper" :class="{ bounceInUp: bounceInUp }">
        <div class="letter-box" :class="{ letterExpand }">
          <div class="letter" :class="{ rollingUp }" @click="next">
            ...
            <PgaeSkeleton
              :rotate="index * 2"
              :index="index"
              v-if="articleSkeleton > 0 && isShow"
              v-for="index in articleSkeleton"
              :key="index"
            />
          </div>
        </div>
        <div class="envelope-box" :class="{ fadeOut }">
          ...
          <div class="cover" :class="{ openEnvelope }"></div>
...
.fadeOut {
  animation: 0.5s 0.5s forwards fadeOut;
}

.openEnvelope {
  animation: 0.8s 0.3s forwards openEnvelope;
}
...
.letterExpand {
  animation: 0.5s 0.5s forwards letterExpand;
}
